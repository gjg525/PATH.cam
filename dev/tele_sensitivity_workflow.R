...
tele_sens_dat <- expand.grid(
  tibble::tibble(
    t_sample_freq = c(1, 4, 12), # GPS sampling frequency (hours)
    ID_sample_size = c(10, 25, 50) # Number of collared animals
  )
)
...
for (tt in 1:nrow(tele_sens_dat)) {
  tele_sample <- tele_sens_dat[tt,]
